!function() {
    "use strict";
    var e, t, n, a, o = localStorage.getItem("language"), s = "en";
    function l(e) {
        ...
        e && e.forEach(function(o) {
            !function e() {
                var t = +o.getAttribute("data-target")
                  ...
                  , a = t / 250;
                a < 1 && (a = 1),
                n < t ? (o.innerText = (n + a).toFixed(0),
                setTimeout(e, 1)) : o.innerText = t
            }()
        })
    }
    function d() {
        setTimeout(function() {
            ...
            a && (e = a.querySelector(".mm-active .active"),
            300 < (t = e ? e.offsetTop : 0) && (t -= 100,
            (n = document.getElementsByClassName("vertical-menu") ? document.getElementsByClassName("vertical-menu")[0] : "") && n.querySelector(".simplebar-content-wrapper") && setTimeout(function() {
    ...
    function c(e) {
        ...
        var n = setInterval(function() {
            ...
            0 < t.style.opacity ? t.style.opacity -= .2 : (clearInterval(n),
    ...
    function u() {
        ...
        n = e,
        1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === n ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
        ...
        sessionStorage.setItem("is_visited", "layout-direction-ltr")) : 1 == document.getElementById("layout-direction-rtl").checked && "layout-direction-rtl" === n && (document.getElementById("layout-direction-ltr").checked = !1,
    ...
    function() {
        ...
        for (var e = document.getElementsByClassName("vertical-menu-btn"), n = 0; n < e.length; n++)
            e[n] && e[n].addEventListener("click", function(e) {
                ...
                992 <= window.innerWidth ? null == t ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == t ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm") : d()
            })
    }(),
    setTimeout(function() {
        ...
        e && e.forEach(function(e) {
            ...
            e.href == l && (e.classList.add("active"),
    ...
    (e = document.querySelectorAll(".navbar-nav a")) && e.forEach(function(e) {
        ...
        e.href == i && (e.classList.add("active"),
    ...
    (n = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == n.getAttribute("data-layout") ? (m("layout-horizontal"),
    document.getElementById("sidebar-setting").style.display = "none") : m("layout-vertical"),
    n.hasAttribute("data-layout-mode") && "dark" == n.getAttribute("data-layout-mode") ? m("layout-mode-dark") : m("layout-mode-light"),
    n.hasAttribute("data-layout-size") && "boxed" == n.getAttribute("data-layout-size") ? m("layout-width-boxed") : m("layout-width-fluid"),
    n.hasAttribute("data-layout-scrollable") && "true" == n.getAttribute("data-layout-scrollable") ? m("layout-position-scrollable") : m("layout-position-fixed"),
    n.hasAttribute("data-topbar") && "dark" == n.getAttribute("data-topbar") ? m("topbar-color-dark") : m("topbar-color-light"),
    n.hasAttribute("data-sidebar-size") && "sm" == n.getAttribute("data-sidebar-size") ? m("sidebar-size-small") : n.hasAttribute("data-sidebar-size") && "md" == n.getAttribute("data-sidebar-size") ? m("sidebar-size-compact") : m("sidebar-size-default"),
    n.hasAttribute("data-sidebar") && "brand" == n.getAttribute("data-sidebar") ? m("sidebar-color-brand") : n.hasAttribute("data-sidebar") && "dark" == n.getAttribute("data-sidebar") ? m("sidebar-color-dark") : m("sidebar-color-light"),
    ...
    document.querySelectorAll("input[name='layout-mode']").forEach(function(e) {
        e.addEventListener("change", function(e) {
            e && e.target && e.target.value && ("light" == e.target.value ? (document.body.setAttribute("data-layout-mode", "light"),
            ...
            m("sidebar-color-light")) : (document.body.setAttribute("data-layout-mode", "dark"),
    ...
    document.querySelectorAll("input[name='layout-direction']").forEach(function(e) {
        e.addEventListener("change", function(e) {
            e && e.target && e.target.value && ("ltr" == e.target.value ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
            document.getElementById("bootstrap-style").setAttribute("href", "assets/css/bootstrap.min.css"),
            document.getElementById("app-style").setAttribute("href", "assets/css/app.min.css"),
    ...
    function() {
        ...
        e = document.getElementById("topnav-menu-content"),
        t = new bootstrap.Collapse(e,{
            toggle: !1
        }),
        ...
        window.addEventListener("resize", function() {
            t.hide(),
            window.innerWidth < 991 && document.body.classList.remove("horimenu-enabled")
        }));
        ...
        window.addEventListener("scroll", function() {
            (100 < document.documentElement.scrollTop || 0 == document.documentElement.scrollTop) && a && (20 < window.pageYOffset ? s.hide() : s.show(),
            window.innerWidth <= 992 && (a = !1,
            setTimeout(function() {
                a = !1
            }, 500),
            s.hide()))
