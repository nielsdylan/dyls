...
use App\Models\Configuraciones\Nivel;
use App\Models\Configuraciones\Tarifa;
use Exception;
...
class HabitacionController extends Controller
{
    ...
    public function lista()
    {
        ...
        $tarifas    = Tarifa::where('estado',1)->get();
        return view('dyls.configuraciones.habitaciones.lista', get_defined_vars());
    }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('accion', function ($data) {
                ...
                '<div class="flex align-items-center list-user-action" >
                    <a href="#" class="btn btn-warning btn-icon btn-sm editar" data-id="' . $data->id . '" >
                    ...
                    <a href="#" class="btn btn-danger btn-icon btn-sm  ms-2 eliminar" data-id="' . $data->id . '" >
                        <span class="btn-inner">
    ...
    {
        try {
            $data = Habitacion::firstOrNew(['id' => $request->id]);
