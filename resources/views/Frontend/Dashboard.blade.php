@extends('Frontend.Layouts.Appmain')
@section('titulo')
Dyls - Dashboard
@endsection
@section('content')
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="card bg-light mb-0">
                                        <div class="card-body">
                                            <div class="py-2">
                                                ...
                                                <p class="text-muted font-size-15 text-truncate">From Jan
                                                    20,2022 to July,2022</p>
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col">
                                                        <div class="d-flex mt-2">
                                                            <i
                                                                class="mdi mdi-square-rounded font-size-10 text-success mt-1"></i>
                                                            <div class="flex-grow-1 ms-2 ps-1">
                                                                <h5 class="mb-1">3,526,56</h5>
                                                                <p class="text-muted text-truncate mb-0">Net
                                                                    Profit</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="d-flex mt-2">
                                                            <i
                                                                class="mdi mdi-square-rounded font-size-10 text-primary mt-1"></i>
                                                            <div class="flex-grow-1 ms-2 ps-1">
                                ...
                                <div class="col-xl-8">
                                    <div>
                                        <div id="column_chart"
                                            data-colors='["--bs-primary", "--bs-primary-rgb, 0.2"]'
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-1 px-2">
                                ...
                                <div class="order-wid-list d-flex justify-content-between">
                                    <p class="mb-0"><i
                                            class="mdi mdi-square-rounded font-size-10 text-danger me-2"></i>Order
                                        Cancel</p>
                                    <div>
                                            ...
                                            <div class="col-12 col-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-15 mb-1 text-truncate">Facebook
                                                            Ads</h5>
                                        ...
                                        <div class="social-box row align-items-center border-bottom g-0">
                                            <div class="col-12 col-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-15 mb-1 text-truncate">Twitter Ads
                                                        </h5>
                                        ...
                                        <div class="social-box row align-items-center border-bottom g-0">
                                            <div class="col-12 col-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-15 mb-1 text-truncate">linkedin
                                                            Ads</h5>
                                        ...
                                        <div class="social-box row align-items-center border-bottom g-0">
                                            <div class="col-12 col-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-15 mb-1 text-truncate">Youtube Ads
                                                        </h5>
                                        ...
                                        <div class="social-box row align-items-center border-bottom g-0">
                                            <div class="col-12 col-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-15 mb-1 text-truncate">Instagram
                                                            Ads</h5>
                                                        <p class="text-muted mb-0">Chairs</p>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body pb-1">
                                            ...
                                            <ol class="activity-checkout mb-0 mt-2 ps-3">
                                                <li class="checkout-item crypto-activity">
                                                    <div class="avatar checkout-icon">
                                                        <div class="avatar-title rounded-circle bg-primary">
                                                            <i
                                                                class="mdi mdi-cart text-white font-size-17"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="checkout-item crypto-activity">
                                                    <div class="avatar checkout-icon">
                                                        <div class="avatar-title rounded-circle bg-primary">
                                                            <i
                                                                class="mdi mdi-gift text-white font-size-17"></i>
                                                        </div>
                                                    </div>
                                                    <div class="feed-item-list">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 overflow-hidden me-4">
                                                                <h5 class="font-size-15 mb-1 text-truncate">New
                                                                    Order Received</h5>
                                                                <p class="text-truncate text-muted mb-2">Pick
                                                                    Up</p>
                                                            </div>
                                                            <div class="flex-shrink-0 text-end">
                                                ...
                                                <li class="checkout-item crypto-activity">
                                                    <div class="avatar checkout-icon">
                                                        <div class="avatar-title rounded-circle bg-primary">
                                                            <i
                                                                class="mdi mdi-account text-white font-size-17"></i>
                                                        </div>
                                                    </div>
                                                    <div class="feed-item-list">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 overflow-hidden me-4">
                                                                <h5 class="font-size-15 mb-1 text-truncate">
                                                                    Manager Posted</h5>
                                                                <p class="text-truncate text-muted mb-2">In
                                                                    Transit</p>
                                                            </div>
                                                            <div class="flex-shrink-0 text-end">
                                                                <h5 class="mb-1 font-size-15">Nov 03</h5>
                                                ...
                                                <li class="checkout-item crypto-activity">
                                                    <div class="avatar checkout-icon">
                                                        <div class="avatar-title rounded-circle bg-primary">
                                                            <i
                                                                class="mdi mdi-wallet text-white font-size-20"></i>
                                                        </div>
                                                    </div>
                                                    <div class="feed-item-list">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 overflow-hidden me-4">
                                                                <h5 class="font-size-15 mb-1 text-truncate">
                                                                    Have 1 pending order.</h5>
                                                                <p class="text-truncate text-muted mb-2">2 hour
                                                                    ago</p>
                                                            </div>
                                                            <div class="flex-shrink-0 text-end">
                                                ...
                                                <li class="checkout-item crypto-activity">
                                                    <div class="avatar checkout-icon">
                                                        <div class="avatar-title rounded-circle bg-primary">
                                                            <i
                                                                class="mdi mdi-weight text-white font-size-20"></i>
                                                        </div>
                                                    </div>
                                                    <div class="feed-item-list">
                                                        <div class="d-flex">
                                    ...
                                    <div id="chart-area" data-colors='["--bs-primary"]' class="apex-charts">
                                    </div>
                                    ...
                                    <div class="swiper-wrapper">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="font-size-17 mt-1">
                                                        <a href="ecommerce-product-detail.html"
                                                            class="text-dark lh-base">Stylish Cricket & Walking
                                                            Light Weight Shoes</a>
                                                    </h5>

                                                    <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                            class="font-size-17 text-muted fw-normal me-1">$280</del>
                                                        $140.00</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card dash-product-box shadow-none border mb-0">
                                                <div class="card-body">
                                                    <div class="dash-product-img">
                                                        <img src="{{ asset('assets/images/product/img-2.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>

                                                    <h5 class="font-size-17 mt-1">
                                                        <a href="ecommerce-product-detail.html"
                                                            class="text-dark lh-base">Combo Pack of 2 Sports
                                                            Shoes Running Shoes</a>
                                                    </h5>

                                                    <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                            class="font-size-17 text-muted fw-normal me-1">$320</del>
                                                        $280.00</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card dash-product-box shadow-none border mb-0">
                                                <div class="card-body">
                                                    <div class="dash-product-img">
                                                        <img src="{{ asset('assets/images/product/img-3.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>

                                                    <h5 class="font-size-17 mt-1">
                                                        <a href="ecommerce-product-detail.html"
                                                            class="text-dark lh-base">Trendy Men Sports Running
                                                            Running Shoes</a>
                                                    </h5>

                                                    <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                            class="font-size-17 text-muted fw-normal me-1">$740</del>
                                                        $520.00</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card dash-product-box shadow-none border mb-0">
                                                <div class="card-body">
                                                    <div class="dash-product-img">
                                                        <img src="{{ asset('assets/images/product/img-6.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>

                                                    <h5 class="font-size-17 mt-1">
                                                        <a href="ecommerce-product-detail.html"
                                                            class="text-dark lh-base">Sneakers For Women Sports
                                                            Running Shoes (Blue)</a>
                                                    </h5>

                                                    <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                            class="font-size-17 text-muted fw-normal me-1">$530</del>
                                                        $420.00</h5>
