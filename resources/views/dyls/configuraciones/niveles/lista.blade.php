    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Gestion de niveles</h4>
            </div>
        </div>
        <div class="card-body">
...
@endsection
@section('script')
    <script src="{{ asset('dyls/configuraciones/niveles/niveles-model.js') }}"></script>
    <script src="{{ asset('dyls/configuraciones/niveles/niveles-view.js') }}"></script>
    <script>
        const view = new NivelesView(new NivelesModel(token));
        view.listar();
        view.eventos();
    </script>
@endsection
