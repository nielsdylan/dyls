...
@endsection
@section('script')
    <script src="{{ asset('dyls/configuraciones/tarifas/tarifas-model.js') }}"></script>
    <script src="{{ asset('dyls/configuraciones/tarifas/tarifas-view.js') }}"></script>
    <script>
        const view = new TarifasView(new TarifasModel(token));
        view.listar();
        view.eventos();
    </script>
@endsection
