    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Gestion de habitaciones</h4>
            </div>
        </div>
        <div class="card-body">
                ...
                <form action="" id="guardar-modal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="nivel_id" class="form-select form-select-sm mb-3 shadow-none" name="nivel_id">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="categoria_id" class="form-select form-select-sm mb-3 shadow-none" name="categoria_id">
                                        <option value="">Seleccione...</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="tarifa_id">Tarifas</label>
                                    <select id="tarifa_id" class="form-select form-select-sm mb-3 shadow-none" name="tarifa_id">
                                        <option value="">Seleccione...</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="precio" class="form-control form-control-sm" type="text" name="precio" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control form-control-sm" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{ asset('dyls/configuraciones/habitaciones/habitaciones-model.js') }}"></script>
    <script src="{{ asset('dyls/configuraciones/habitaciones/habitaciones-view.js') }}"></script>
    <script>
        const view = new HabitacionesView(new HabitacionesModel(token));
        view.listar();
        view.eventos();
    </script>
@endsection
