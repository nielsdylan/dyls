...
@endsection
@section('script')
    <script src="{{ asset('dyls/configuraciones/clientes/clientes-model.js') }}"></script>
    <script src="{{ asset('dyls/configuraciones/clientes/clientes-view.js') }}"></script>
    <script>
        const view = new ClientesView(new ClientesModel(token));
        view.listar();
        view.eventos();
    </script>
@endsection
