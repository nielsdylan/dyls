                    ...
                    <ul class="iq-nav-menu list-unstyled">
                        <li class="nav-item ">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                <li class="nav-item"><a class="nav-link " href="../dashboard/index.html">Dashboard</a>
                                </li>
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/special-pages/calender.html">Calender</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/auth/two-factor.html">Two Factor</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/auth/account-deactivate.html">Account Deactivate</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                <li class="nav-item">
                                    <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#ui-element"
                                        role="button" aria-expanded="false" aria-controls="ui-element">
                                        UI Elements
                                        <i class="right-icon">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        id="ui-element">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-avatars.html">Avatars</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-alerts.html">Alerts</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-badges.html">Badge</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-breadcrumb.html">Breadcrumb</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-buttons.html">Buttons</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-buttons-group.html">Buttons Group</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-boxshadow.html">Box Shadow</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-color.html">Colors</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-cards.html">Cards</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-carousel.html">Carousel</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-grid.html">Grid</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-images.html">Images</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-list-group.html">List Group</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-modal.html">Modal</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-notifications.html">Notifications</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-pagination.html">Pagination</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-popovers.html">Popovers</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-typography.html">Typography</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-tabs.html">Tabs</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-tooltips.html">Tooltips</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/ui-embed-video.html">Video</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                            ...
                            <div class="p-0 card-body all-notification">
                                <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('Template/images/avatars/01.png') }}"
                                ...
                                <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('Template/images/avatars/02.png') }}"
                                            class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                    </div>
                                    <div class="d-flex flex-column ms-3 w-100">
                                ...
                                <div class="d-flex align-items-center search-hover py-2 px-3 border-bottom">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('Template/images/avatars/03.png') }}"
                                            class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                    </div>
                                    <div class="d-flex flex-column ms-3 w-100">
                                ...
                                <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('Template/images/avatars/04.png') }}"
                                            class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                    </div>
                                    <div class="d-flex flex-column ms-3 w-100">
                                        <a href="javascript:void(0);" class="h5">Monty Carlo</a>
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting"
                        ...
                        <img src="{{ asset('Template/images/avatars/01.png') }}" alt="User-Profile"
