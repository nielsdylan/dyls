<aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour"
    ...
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <!--logo End-->
            <h4 class="logo-title" data-setting="app_name">DYLS</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('dyls.dashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('dyls.reservas.calendario') }}">
                        <i class="icon" data-bs-toggle="tooltip" title="Reserva" data-bs-placement="right">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                                    d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                        ...
                        <span class="item-name">Reserva</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('dyls.recepcion.lista') }}">
                        <i class="icon" data-bs-toggle="tooltip" title="Recepción" data-bs-placement="right">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                                    d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                        ...
                        <span class="item-name">Recepción</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('dyls.verificacion-salida.lista') }}">
                        <i class="icon" data-bs-toggle="tooltip" title="Recepción" data-bs-placement="right">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Verificación de salidas</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.configuraciones.categorias.lista') }}">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Categorías" data-bs-placement="right"> C </i>
                                <span class="item-name">Categorías</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.configuraciones.habitaciones.lista') }}">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Habitaciones" data-bs-placement="right"> H </i>
                                <span class="item-name">Habitaciones</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.configuraciones.tarifas.lista') }}">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Tarifas" data-bs-placement="right"> T </i>
                                <span class="item-name">Tarifas</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.configuraciones.clientes.lista') }}">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Clientes" data-bs-placement="right"> T </i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu-punto-venta" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.punto-venta.ventas.lista') }}">
                              <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('dyls.punto-venta.productos.lista') }}">
                              <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
