...
<head>
    ...
    <title
    {{-- data-setting="app_name" data-rightJoin=" Dyls Dashboard Template" --}}
    >Dyls Dashboard
        Template</title>
    <meta name="description"
        content="Dyls Dashboard Template and UI Components Library. The Admin Dashboard Template and UI Component features 8 modules.">
    <meta name="keywords"
    ...
    <meta name="DC.title" content="Dyls Dashboard Template">

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('Template/images/favicon.ico') }}">

    @include('dyls.Layouts.css')
    @yield('css')
...
<body class="  ">
    ...
    <!-- loader END -->
    @include('dyls.Layouts.sidebar')
    <main class="main-content">
        <div class="position-relative  @yield('banner') ">
            <!--Nav Start-->
            @include('dyls.Layouts.navbar')
